...
class MainWindow(tk.Tk):
    def __init__(self):
        ...
        self.btn_export = tk.Button(self, text="Export", command=self.exporttoxl)
        ...
        self.table_bom = ttk.Treeview(self, columns=self.columns, height=35, show='headings')
        ...
        # widgets placements
        self.lbl_stockcode.grid(row=0, column=0, sticky='w', padx=5)
        self.entry_stockcode.grid(row=0, column=1, sticky='w', padx=5)
        self.lbl_category.grid(row=1, column=0, sticky='w', padx=5)
        self.entry_category.grid(row=1, column=1, columnspan=2, sticky='w', padx=5)
        ...
        self.lbl_message.grid(row=4, column=1, columnspan=2, sticky='w')
        self.btn_table_entry.grid(row=0, column=4)
        self.btn_remove.grid(row=1, column=4)
        self.btn_refresh.grid(row=2, column=4)
        self.table_bom.grid(row=10, rowspan=35, column=0, columnspan=5, padx=5, pady=5)
        self.scrollbar.grid(row=10, rowspan=35, column=5, sticky='ns')
        self.btn_up.grid(row=10, column=6)
        self.btn_down.grid(row=11, column=6)
        self.btn_exit.grid(row=50, column=1)
        self.btn_export.grid(row=50, column=0)

    # TODO: add a counter of total number of items (use for yview fraction) & display to user
    # TODO: add a counter of items with different thickness
    ...
    def select_latest(self, row):
        ...
        # last_index = len(child) - 1
        self.table_bom.focus(child[row - 1])
        self.table_bom.selection_set(child[row - 1])
